...
lv_obj_t *ui_add_coin_screen_create(void)
{
    ...
    lv_obj_set_width(s_search_field, 600);
    lv_obj_align(s_search_field, LV_ALIGN_TOP_LEFT, 16, 55);
    ...
    s_search_btn = lv_btn_create(screen);
    lv_obj_set_size(s_search_btn, 140, 38);
    lv_obj_align(s_search_btn, LV_ALIGN_TOP_RIGHT, -16, 55);
    ...
    lv_obj_align(s_status, LV_ALIGN_TOP_LEFT, 16, 97);

    s_results = lv_obj_create(screen);
    lv_obj_set_size(s_results, 780, 210);
    lv_obj_align(s_results, LV_ALIGN_TOP_LEFT, 10, 116);
    ...
    lv_label_set_text(s_preview, "Select a coin to preview");
    lv_obj_set_style_text_color(s_preview, lv_color_hex(ADD_TEXT_COLOR), 0);
    lv_obj_align(s_preview, LV_ALIGN_TOP_LEFT, 16, 336);

    s_add_btn = lv_btn_create(screen);
    lv_obj_set_size(s_add_btn, 140, 40);
    lv_obj_align(s_add_btn, LV_ALIGN_TOP_RIGHT, -16, 328);
